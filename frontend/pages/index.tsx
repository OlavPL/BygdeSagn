import CardFortelling from '../components/LoreCard/Card_fortelling';
...
const Home = () => (
  <div className="bg-gray-200 min-h-screen flex flex-col items-center justify-center">
    ...
    <div className="w-full">
      ...
      <CardFortelling title="Unpopular Opinion" text={bodyOfText} tags={["Fortelling","Sadge","Sagn","sagn"]} likes={222} dislikes={69} />
    </div>
  </div>
);
