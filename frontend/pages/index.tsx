  ...
  <div className="bg-gray-200 min-h-screen flex flex-col items-center">
    ...
    <div className="pt-10 space-y-2">
      <form className='space-y-2'>
        <div className='flex bg-slate-600 outline-2 focus-within:outline outline-blue-500 rounded'>
          <span > 
        ...
        <div className='flex flex-row  space-x-2'>
            {/* <div className='flex bg-slate-600 outline-2 '> */}
            {/* <span > 
              <FontAwesomeIcon icon={faLocationDot} className="p-2"/>
            </span> */}
              {/* <input className=" grow bg-slate-600 focus:outline-none rounded " placeholder='Søk på sted...'/> */}
      ...
      <div className="w-full">
        ...
        <Card_fortelling title="Unpopular Opinion" text={bodyOfText} tags={["Fortelling","Sadge","Sagn","sagn"]} likes={222} dislikes={69} />
      </div>
